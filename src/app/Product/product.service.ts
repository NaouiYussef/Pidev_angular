...
public showAttribute():Observable<Attribute[]>{
  return this.http.get<Attribute[]>(this.host+"/attribute");
}
public AfficherAttributByID(id: number):Observable<Attribute>{
    return this.http.get<Attribute>(this.host+"/showAttributeById/"+id);
}
}
